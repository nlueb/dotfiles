...
Group.new('ColorColumn', c.none, c.blacker, s.none)
...
Group.new('SLDarkText', c.blacker, c.black, s.none)
...
-- Refactor {{{
Group.new('TSDefinitionUsage', c.white, c.none, s.none)
Group.new('TSDefinition', c.pink, c.none, s.none)
-- }}}
